export default {
    ...
    async login() {
        try {
            if (!Input_Username.text || !Input_CurrentPassword.text) {
            ...
            if (user.is_temp_password) {
                ...
                isValidPassword = (PasswordUtils.simpleHash(Input_CurrentPassword.text) === user.password_hash);
            } else {
                // Full hash verification for permanent passwords
                isValidPassword = await PasswordUtils.verifyPassword(
                    Input_CurrentPassword.text,
                    user.password_hash,
                    user.salt
                );
            }
